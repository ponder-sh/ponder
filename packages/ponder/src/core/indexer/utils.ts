...
//     results.push(...lines); // append the array lines to the array results
//   }
//   return results;
// }
...
//  */
// function p1_excluding_all(p1: number[], exclude: number[][]) {
//   const checking = [p1];
//   for (let i = 0; i < exclude.length; i++) {
//     checking.push(...points_excluding_p2(checking, exclude[i]));
//   }
