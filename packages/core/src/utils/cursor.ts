import { BaseError, type ByteArray } from "viem";

/**
 * @see https://github.com/wevm/viem/blob/main/src/utils/cursor.ts
 * @see https://github.com/wevm/viem/blob/main/src/errors/cursor.ts
 */
