...
test("checkpointMax returns correct value if only one checkpoint", () => {
  const checkpointOne = { blockTimestamp: 1, chainId: 1, blockNumber: 1 };
...
test("checkpointMax compares properly on timestamp", () => {
  const checkpointOne = { blockTimestamp: 1, chainId: 1, blockNumber: 1 };
  const checkpointTwo = { blockTimestamp: 2, chainId: 1, blockNumber: 1 };
...
test("checkpointMax compares properly on chainId", () => {
  const checkpointOne = { blockTimestamp: 1, chainId: 1, blockNumber: 1 };
  const checkpointTwo = { blockTimestamp: 1, chainId: 2, blockNumber: 1 };
...
test("checkpointMax compares properly on blockNumber", () => {
  const checkpointOne = { blockTimestamp: 1, chainId: 1, blockNumber: 1 };
  const checkpointTwo = { blockTimestamp: 1, chainId: 1, blockNumber: 3 };
...
test("checkpointMin compares properly on blockNumber", () => {
  const checkpointOne = { blockTimestamp: 1, chainId: 1, blockNumber: 1 };
  const checkpointTwo = { blockTimestamp: 2, chainId: 1, blockNumber: 3 };
