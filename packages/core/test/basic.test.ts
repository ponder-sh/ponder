...
//       expect(ponder.resources.contracts.length).toBe(1);
//       const contract = ponder.resources.contracts[0];
...
//       expect(ponder.resources.database.kind).toBe("sqlite");
//     });

//     it("builds a cache store", async () => {
//       expect(ponder.resources.cacheStore).toBeInstanceOf(SqliteCacheStore);
//     });

//     it("builds an entity store", async () => {
//       expect(ponder.resources.entityStore).toBeInstanceOf(SqliteEntityStore);
//     });
//   });
...
//       const tables = (ponder.resources.database as SqliteDb).db
