---
description: "A guide on how to develop with foundry"
---
...
Ponder makes it convenient to test indexing events when developing your dapp locally. Check out the [foundry example](https://github.com/0xOlias/ponder/tree/main/examples/project-foundry) to see an example on how you can get started working with ponder and foundry.
