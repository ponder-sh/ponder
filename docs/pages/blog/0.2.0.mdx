---
title: "0.2 - Concurrent indexing and cursor pagination"
description: "A blog post for the 0.2 release which introduces concurrent indexing and cursor pagination."
---
...
<div className="flex flex-row items-center gap-4 mt-5">
  ...
  <div className="flex flex-col">
    ...
    <span className="text-sm text-gray-400 dark:text-gray-500">March 15, 2024</span>
  </div>
</div>
