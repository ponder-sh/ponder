...
| **maxRpcRequestConcurrency** | `number \| undefined` | **Default: `10`**. Maximum concurrency of RPC requests during the historical sync. Can be reduced to work around rate limits. |
