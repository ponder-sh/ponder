...
| **factory**          | [`FactoryConfig`](#factoryconfig)`\| undefined` | Factory contract configuration to be set if instances of this contract are created by a factory. Not required if `address` is provided.                                                                                          |
