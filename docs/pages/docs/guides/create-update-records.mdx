...
- [`create`](/docs/guides/create-update-records#create)
- [`update`](/docs/guides/create-update-records#update)
- [`upsert`](/docs/guides/create-update-records#upsert)
- [`delete`](/docs/guides/create-update-records#delete)
- [`findUnique`](/docs/guides/create-update-records#findunique)
- [`findMany`](/docs/guides/create-update-records#findmany)
- [`createMany`](/docs/guides/create-update-records#createmany)
- [`updateMany`](/docs/guides/create-update-records#updatemany)
...
`findMany` returns a list of records according to the filter, sort, and pagination options you provide. Note that `findMany` offers programmatic access to the functionality exposed by the autogenerated [GraphQL API](/docs/guides/query-the-graphql-api).
...
`updateMany` updates multiple records in a single operation using the same update logic. Like the `update` method, `updateMany` also optionally accepts an [update function](/docs/guides/create-update-records#update-function).
