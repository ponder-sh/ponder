...
See [Design your schema](/docs/guides/design-your-schema) for a detailed guide on schema design.
...
See [Create & update records](/docs/guides/create-update-records) for a detailed guide on writing indexing functions.
