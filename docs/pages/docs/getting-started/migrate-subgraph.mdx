...
See [tips for migrating mapping functions](/docs/getting-started/migrate-subgraph#tips-for-migrating-mapping-functions) for more details.
...
See the [Create & update records](/docs/guides/create-update-records) and [Read contract data](/docs/guides/read-contract-data) guides for more details.
