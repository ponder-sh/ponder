...
When provided, Ponder will use WebSocket connections for realtime block subscriptions instead of polling. Websocket connections offer lower latency and reduced RPC usage.
