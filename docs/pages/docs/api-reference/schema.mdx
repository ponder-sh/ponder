...
1. [Design your schema](/docs/guides/design-your-schema)
2. [Create & update records](/docs/guides/create-update-records)
3. [Query the GraphQL API](/docs/guides/query-the-graphql-api)
