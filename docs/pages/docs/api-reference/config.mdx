...
The `ponder.config.ts` file contains contract names, addresses, and ABIs; chain information like IDs and RPC URLs; database configuration; and general options.
...
| **rpcUrls**              | `string \| string[] \| viem.Transport`    | An rpc url, list of rpc urls or a viem [Transport](https://viem.sh/docs/clients/transports/http.html).                     |
