...
| **startBlock**                 |          `number \| "latest" \| undefined`           | **Default: `0`**. Block number or tag to start syncing events. Usually set to the contract deployment block number.                                                                                                            |
| **endBlock**                   |          `number \| "latest" \| undefined`           | **Default: `undefined`**. Block number or tag to stop syncing events. If this field is specified, the contract will not be indexed in realtime. This field can be used alongside `startBlock` to index a specific block range. |
