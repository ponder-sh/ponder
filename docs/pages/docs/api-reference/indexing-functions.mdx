...
The `context.db` object contains ORM-style models that can be used to create, read, update, and delete database records. See [Create & update records](/docs/guides/create-update-records) for a detailed overview.
...
<Callout type="info">
  See the [Read contract data](/docs/guides/read-contract-data) guide for more
  details.
</Callout>
