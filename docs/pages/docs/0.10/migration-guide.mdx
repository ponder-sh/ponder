...
:::info
Each deployment/instance of a Ponder app must have its own schema, with some exceptions for `ponder dev` and crash recovery. [Read more](/docs/0.10/database#database-schema).
:::
