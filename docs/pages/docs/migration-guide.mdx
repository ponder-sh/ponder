...
Ponder now emits a more useful set of logs. For the majority of users, this change will be non-breaking.

The changes are focused on making it easier to understand what Ponder is working on at any given moment, and eliminate scenarios where Ponder appears to hang without emitting any logs.
