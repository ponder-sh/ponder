...
Files in the `src/` directory contain **indexing functions**, which are simply TypeScript functions that process a contract event. The purpose of these functions is to insert data into the entity store.
