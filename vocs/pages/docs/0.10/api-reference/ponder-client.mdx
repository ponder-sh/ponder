...
| `options.schema` | `Schema` | The schema exported by `ponder.schema.ts`                  |
...
Returns a Promise that resolves to an object containing the indexing status of each network.
