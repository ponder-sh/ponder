...
Set this option to `true` when indexing a development node like Anvil, where the chain state / history may change. [Read more](/docs/advanced/foundry) about indexing Anvil.
