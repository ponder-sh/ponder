...
# Indexing function API [Register functions to process events]

<Callout type="tip">
  This is a low-level reference. For an introduction, visit the
  [Indexing](/docs/indexing) section.
</Callout>
...
<Callout type="tip">
  The [includeCallTraces](/docs/contracts-and-networks#call-traces) option must
