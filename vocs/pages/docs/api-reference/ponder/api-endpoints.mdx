...
| `/status`  | Returns the current indexing status. [Read more](/docs/guides/observability#indexing-status).                             |
| `/metrics` | Prometheus metrics endpoint. [Read more](/docs/guides/observability#metrics).                                    |
