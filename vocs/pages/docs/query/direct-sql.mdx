...
- **Direct SQL with zero-downtime deployments requires additional setup**. [Read more](/docs/production/deploy/self-hosting#views-pattern) about the views pattern in the production guide.
