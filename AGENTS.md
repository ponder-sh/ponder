...
## Repository Shape
- This is a pnpm `10.34.5` workspace; install with `pnpm install --frozen-lockfile` to match CI. Node must be `>=22`; CI currently uses Node `24.8` and a pinned Foundry nightly.
