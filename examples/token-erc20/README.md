...
This example shows how to create a GraphQL API for an ERC20 token using Ponder. It uses the Adventure Gold token contract, which emits `Transfer`, `Approval`, and `OwnershipTransferred` events.
